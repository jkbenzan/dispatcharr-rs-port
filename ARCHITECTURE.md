...
- **M3U Provider Management**:
    ...
    - **VOD Selection UI**: The provider modal provides dedicated "VOD Movies" and "VOD Series" tabs for granular category selection. These tabs use the same robust classification engine as Live TV categories to identify countries and streaming services (Netflix, Disney+, etc.), providing flags and human-readable metadata.
